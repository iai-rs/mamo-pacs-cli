import numpy as np
from joblib.numpy_pickle_utils import xrange ## VSvenda: imported xrange (function was not found)
...
from keras.preprocessing.image import (
    ImageDataGenerator, 
    Iterator,
    array_to_img ## VSvenda: added (function was not found)
    # NumpyArrayIterator
)
...
from preprocess import preprocess_scan, negate_if_should
...
def read_resize_img(fname, target_size=None, target_height=None, 
    ...
    # img, spatial = preprocess_scan(img) # preprocess if needed
